...
class PredictPipeline:
    ...
    def predict(self, data: pd.DataFrame):
        ...
        try:
            ...
            transformed_data = preprocessor.transform(processed_data)
...
class CustomData:
    ...
    def __init__(
        self,
        amount_val: float,
        oldbalanceOrg_val: float,
        newbalanceOrig_val: float,
        oldbalanceDest_val: float,
        newbalanceDest_val: float,
        type_val: str,
    ):
    ...
    def get_data_as_dataframe(self):
        ...
        try:
            ...
            logger.info("Custom dataframe created successfully")
